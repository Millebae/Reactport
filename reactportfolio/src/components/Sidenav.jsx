...
const Sidenav = () => {
    ...
    return (
        <div>
            <AiOutlineMenu size={50} onClick={handleNav} className='absolute top-4 right-4 z-[99] md:hidden' />
            {
                nav && (
            ...
            <a onClick={handleNav} href='#contact'className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200'>
             ...
             <div className='md:block hidden fixed top-[25] z-10 mt-4'>
                <div className='flex flex-col'>
                    <a href='#main' className='rounded-full shadow-lg bg-grey-100 shadow-gray-400 m-4 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
                        <AiOutlineHome size={30}/>
                    </a>
                    <a href='#work' className='rounded-full shadow-lg bg-grey-100 shadow-gray-400 m-4 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
                        <GrProjects size={30}/>
                    </a>
                    <a href='#projects' className='rounded-full shadow-lg bg-grey-100 shadow-gray-400 m-4 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
                        <AiOutlineProject size={30}/>
                    </a>
                    <a href='#main' className='rounded-full shadow-lg bg-grey-100 shadow-gray-400 m-4 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
                        <BsPerson size={30}/>
                    </a>
                    <a href='#contact' className='rounded-full shadow-lg bg-grey-100 shadow-gray-400 m-4 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
